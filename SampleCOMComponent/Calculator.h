...
#include "SampleCOMComponent_i.h"
...
class ATL_NO_VTABLE CCalculator :
	...
	public IDispatchImpl<ICalculator, &IID_ICalculator, &LIBID_SampleCOMComponentLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CCalculator()
	{
...
public:
	STDMETHOD(AddNumbers)(long a, long b, long* result);
