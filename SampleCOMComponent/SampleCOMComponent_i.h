 ...
 */
/* Compiler settings for SampleCOMComponent.idl:
...
#ifndef __SampleCOMComponent_i_h__
#define __SampleCOMComponent_i_h__
...
EXTERN_C const IID IID_ICalculator;
    ...
    MIDL_INTERFACE("a31ab6c3-01e4-4dbc-9f98-a46dd53f02a7")
    ...
    typedef struct ICalculatorVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ICalculator, AddNumbers)
...
#define ICalculator_AddNumbers(This,a,b,result)	\
    ( (This)->lpVtbl -> AddNumbers(This,a,b,result) ) 
...
#ifndef __SampleCOMComponentLib_LIBRARY_DEFINED__
#define __SampleCOMComponentLib_LIBRARY_DEFINED__

/* library SampleCOMComponentLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_SampleCOMComponentLib;

EXTERN_C const CLSID CLSID_Calculator;

#ifdef __cplusplus

class DECLSPEC_UUID("49904286-f9db-4c72-863b-e96efadde1ff")
Calculator;
#endif
#endif /* __SampleCOMComponentLib_LIBRARY_DEFINED__ */
